import { PocketBaseDataDisplay } from './pages/pocketbase-data-display/index';
          ...
          <RefineSnackbarProvider>
            <Refine
              ...
              resources={[
                ...
                {
                    name: "pocketbase-data-display",
                    list: "/pocketbase-data-display",
                  },
                {
                  name: "orders",
                  list: "/orders",
            ...
            >
              <Routes>
                ...
                >
                  ...
                  <Route path="/pocketbase-data-display" element={< PocketBaseDataDisplay/>} />

                  <Route path="/form-builder" element={<ProductList />} />
                  <Route path="/schema-builder" element={<ProductList />} />
